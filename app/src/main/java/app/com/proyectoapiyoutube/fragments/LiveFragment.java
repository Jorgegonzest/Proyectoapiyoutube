...
public class LiveFragment extends Fragment {
    ...
    private static String PLAYLIST_ID = "PLU12uITxBEPFT10z9aLSQpg0YD4su7JDp";//here you should use your playlist id for testing purpose you can use this api also
